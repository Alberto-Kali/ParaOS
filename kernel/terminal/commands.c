...
void help()
{
    printlnVGA("Available commands: ");
    printlnVGA("help: Prints this message");
    printlnVGA("halt: Halts the CPU");
    printlnVGA("time: Prints current time");
    printlnVGA("say: Prints whatever comes afterwards.");
    printlnVGA("malloc: Allocates memory");
    printlnVGA("dealloc: Deallocates memory");
    printlnVGA("inf_loop: Runs an infinite loop");
    printlnVGA("showval: Shows the value of val");
    printlnVGA("cpu_info: Prints CPU info");
    printlnVGA("charprint: Prints a character");
    printlnVGA("sample_command: A sample command");
    printlnVGA("dample_command: A sample command with arguments");
}
...
void ascii_art()
{
    ...
    printlnVGA("     |  .-----------------.  |  |     +---------+      |            ");
    printlnVGA("     |  |                 |  |  |     | -==----'|      |            ");
    printlnVGA("     |  |  I LOVE DOS!    |  |  |     |         |      |            ");
    printlnVGA("     |  |  Bad command or |  |  |/----|`---=    |      |            ");
    printlnVGA("     |  |  C:\\>_          |  |  |   ,/|==== ooo |      ;            ");
    printlnVGA("     |  |                 |  |  |  // |(((( [33]|    ,\"              ");
    printlnVGA("     |  `-----------------'  |,\" .;'| |((((     |  ,\"                ");
    printlnVGA("     +-----------------------+  ;;  | |         |,\"     -||-  ");
    printlnVGA("        /_)______________(_/  //'   | +---------+                    ");
    printlnVGA("   ___________________________/___  `,                              ");
    printlnVGA("  /  oooooooooooooooo  .o.  oooo /,   \\,-----------                 ");
    printlnVGA(" / ==ooooooooooooooo==.o.  ooo= //   ,`\\--{)B     ,\"              ");
    printlnVGA("/_==__==========__==_ooo__ooo=_/'   /___________,\"               ");
    printlnVGA("`-----------------------------'                                         ");
}
